...
Tinytest.add('ReactiveObjects - private api - _reactiveDeps holds hidden deps handles for the set/get(s) on the object', function(test) {
  ...
  test.isTrue(obj._reactiveDeps.Prop1Deps.hasOwnProperty('_dependentsById'), 'should hold the deps for property 1') //deps exists
  test.isTrue(obj._reactiveDeps.Prop2Deps.hasOwnProperty('_dependentsById'), 'should hold the deps for property 2') //deps exists
  test.isTrue(obj._reactiveDeps.Prop3Deps.hasOwnProperty('_dependentsById'), 'should hold the deps for property 3') //deps exists
