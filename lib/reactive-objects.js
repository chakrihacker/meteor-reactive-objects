...
Behave.addBehavior('ReactiveObject', function (setup) {
  ReactiveObject.dynamicproxies = setup.dynamicproxies; //model vars
  ReactiveObject.proxies = _.defaults(setup.proxies, ReactiveObject.proxies) //setup proxies overload
