...
ReactiveObjects.setProperty = function (propObj, propName, mixinObj) {
  ...
  Object.defineProperty(propObj, propName, {
    ...
    get: function () {
      if (mixinObj && mixinObj.hasOwnProperty('beforeGet')) {
        if (mixinObj.beforeGet(this)) {
      ...
      if (mixinObj && && mixinObj.hasOwnProperty('afterGet')) {
        return mixinObj.afterGet(this, propObj[propName])
      }
    },
   
    set: function (value) {
      if (mixinObj && mixinObj.hasOwnProperty('beforeSet')) {
        if (mixinObj.beforeSet(this, value)) {
      ...
      if (mixinObj && mixinObj.hasOwnProperty('afterSet')) {
        mixinObj.afterSet(this, value)
      }
    }
