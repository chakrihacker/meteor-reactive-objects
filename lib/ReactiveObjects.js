...
ReactiveObjects.setProperty = function (propObj, propName, mixinObj) {
  ...
  Object.defineProperty(propObj, propName, {
    ...
    get: function () {
      ...
      if (mixinObj && mixinObj.hasOwnProperty('get')) { mixinObj.get.call(getter) }
      if (!getter.stop) {
    ...
    set: function (value) {
      getter = { stop: false, value: value, oldValue: propObj._reactiveProperties[propName] }
      if (mixinObj && mixinObj.hasOwnProperty('set')) { mixinObj.set.call(getter) }
      if (!getter.stop) {
        propObj._reactiveProperties[propName] = getter.value;
